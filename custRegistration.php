...
<head>
  <meta charset="UTF-8">
  <title>Car Rental - Customer Registration &amp;  html css &amp; javascript</title>
...
<div class="wrapper">
      <div class="title-text">
        ...
        <div class="form-inner">
          ...
          <form action="custFormValidation.php" method="post" class="signup">
    
            <table class="field">
                <tr>
                <td><input type="text"  name="fname" placeholder="First Name" required></td><td><input type="text" name="lname" placeholder="Last Name" required></td>
                </tr>
            </table>
